 ...
 */
 ;window.Modernizr = function(a, b, c) {
    ...
    function(a, b) {
        ...
        // var yU = window.location.href;
        // if (yU.indexOf("yidiantime") < 0) {
        //     // copyright
        //     $(img).attr('src', 'http://www.yidiantime.com/wp-content/themes/new15/dt.jpg');
        // }
        function m(a) {
            var b = i[a[g]];
...
function(a, b, c) {
    ...
    B = function(a) {
        ...
        function g(a, e, f, g, h) {
            ...
            i.bypass || (e && (e = d(e)
                ? e
                : e[a] || e[g] || e[a.split("/").pop().split("?")[0]]), i.instead
                ? i.instead(a, e, f, g, h)
                : (y[i.url]
                    ? i.noexec = !0
